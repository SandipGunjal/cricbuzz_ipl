...
router.post("/signup", async (req, res) => {
  ...
  i{
    font-family:'Trebuchet MS', sans-serif;
      ...
      <body>
        ...
        <div class="footer">
          <p>This is Created by Author : &copy; <i>Sandip Gunjal❤️</i> 2024🌴</p>
        </div>
      </body>
    </html>`
  ...
  const transporter = nodemailer.createTransport({
    ...
    port: 465,
    auth: {
      user: "sandipgunjal8998@gmail.com", // replace with your email
      pass: "yozgmapogmvlnzhl", // replace with your email password
    },
  });
  
  var info = transporter.sendMail({
    from:'"Cricbuzz 🏏🤾"<sandipgunjal8998@gmail.com>',
    to: req.body.email,
